# Bunker Mini + LSLIDAR N10 bringup launch
# 与 bunker_robot.launch.py 相同，但将 RPLIDAR A1 替换为 LSLIDAR N10 串口雷达
...
def generate_launch_description():
    ...
    # LSLIDAR N10 替代 RPLIDAR A1
    lslidar_n10_launch_path = PathJoinSubstitution(
    ...
    return LaunchDescription([
        ...
        # Launch LSLIDAR N10 (publishes to /scan, frame_id: laser)
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(lslidar_n10_launch_path)
        ),

        # Launch YESENSE network IMU (optional)
        IncludeLaunchDescription(
        ...
        # Launch sensors (depth camera etc, driven by LINOROBOT2_LASER_SENSOR env)
        IncludeLaunchDescription(
