...
# 可视化所有路径
save_img = "images/Schematic/compare_paths2_25x25.tiff"
show_paths(grid, paths_for_plot, start, goal, save_path=save_img)

# 保存结果
df = pd.DataFrame(results)
df.to_csv("data/results/compare_results_schematic.csv", index=False)
print("\n✅ 实验完成，结果保存为 compare_results_schematic.csv")
print(df)
